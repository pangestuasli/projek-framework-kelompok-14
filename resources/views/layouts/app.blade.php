...
<head>
    ...
    <title>@yield('title', 'Dashboard') - Produk Hukum & Dokumen Publik</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ request()->routeIs('jenis_dokumen.*') ? 'active' : '' }}">
            ...
            <!-- Nav Item - Ketua -->
            <li class="nav-item {{ request()->routeIs('ketua') ? 'active' : '' }}">
